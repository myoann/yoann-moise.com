<?php
	...
	// -- insert 
	function addNewUser($dbh,$FirstName,$LastName,$User_Description, $User_Photo, $User_Address, $Email,$Password){
		$stmt=$dbh->prepare('INSERT INTO user (First_Name,Last_Name,User_Description,User_Photo,User_Address,Email,Password) VALUES (:FirstName,:LastName,:User_Description,:User_Photo,:User_Address,:Email,:Password)');
	...
	$default_profile_description = "Hi everyone! My life is all about food, what about you? ;-) ";
	$default_profile_picture = "http://www.oac-architectes.org/webroot/images/profil.png";
	$default_profile_address = "Somewhere";
	...
	if (isset($action)){
		...
		switch($action){
			// -- ajouter
			case "addNewUser":
			addNewUser($dbh,$_POST['FirstName'],$_POST['LastName'],$default_profile_description, $default_profile_picture, $default_profile_address, $_POST['Email'],$_POST['Password']);
			break;
			case "addNewMeal":
