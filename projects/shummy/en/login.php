...
<section class="section_register">
  <fieldset class="form_register">
    ...
    <table>
      ...
      <tr><td><input required type="email" placeholder="Email" id="Email" value="barack@obama.com" /></td></tr>
      <tr><td><input required type="password" placeholder="Password" id="Password" value="obama" /></td></tr>
